    ...
    $jc.fn.extend({
        ...
        animate: function(p, a) {
            ...
            if (!this.options.animation || a === false) {
                ...
                var o = (this.options.fadeEffect) ? {'opacity': 0} : !this.options.vertical ? (this.options.rtl ? {'right': p} : {'left': p}) : {'top': p};
                ...
                if(this.options.fadeEffect) this.list.css(this.lt, p + 'px');
